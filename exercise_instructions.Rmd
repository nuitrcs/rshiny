...
Working from exercises/exercise2/app.R or answer2b.R, set the `brush` argument to `plotOutput="plot1_brush"`.  Change `DT::renderDataTable` to use output from `brushedPoints` instead.
...
* "By Region" tab: New plot with ID "regionplot" (there's code already in server section to actually make the plot)
